...
Storable products use standard Odoo inventory. Optional pack UoM (e.g. Crate x24) with
Bottle/Can conversion on order lines. No kit/phantom BOM explosion.
""",
    'depends': [
        'purchase',
        'stock_account',
    ...
    'data': [
        ...
        'wizard/rdl_template_import_wizard_views.xml',
